...
#Set each model. We will be using both the linear kernel method and the RBF kernel method
...
for fig_num, model in enumerate(('Linear Kernel', 'RBF Kernal')):
